...
.rbe-table tbody tr:hover td { background: var(--color-row-hover, var(--ac-blue-soft, #eff6ff)); }
...
.rbe-table tbody tr:hover td.rbe-table-sticky-td { background: var(--color-row-hover, var(--ac-blue-soft, #eff6ff)); }
...
export function ensureTableStyles(): void {
